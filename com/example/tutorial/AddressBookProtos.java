...
public final class AddressBookProtos {
  ...
  /**
   * <pre>
   *message aggregate that holds set of typed fields
   * </pre>
   *
  ...
  public interface AddressBookOrBuilder extends
    ...
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
     ...
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    com.example.tutorial.AddressBookProtos.Person getPeaople(int index);
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    int getPeaopleCount();
    ...
    java.util.List<? extends com.example.tutorial.AddressBookProtos.PersonOrBuilder> 
        getPeaopleOrBuilderList();
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    com.example.tutorial.AddressBookProtos.PersonOrBuilder getPeaopleOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private AddressBook() {
      peaople_ = java.util.Collections.emptyList();
    }
    ...
    private AddressBook(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                peaople_ = new java.util.ArrayList<com.example.tutorial.AddressBookProtos.Person>();
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          peaople_ = java.util.Collections.unmodifiableList(peaople_);
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    public static final int PEAOPLE_FIELD_NUMBER = 1;
    private java.util.List<com.example.tutorial.AddressBookProtos.Person> peaople_;
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    public java.util.List<com.example.tutorial.AddressBookProtos.Person> getPeaopleList() {
      return peaople_;
    }
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     ...
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    public int getPeaopleCount() {
      return peaople_.size();
    }
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    public com.example.tutorial.AddressBookProtos.Person getPeaople(int index) {
      return peaople_.get(index);
    }
    /**
     * <code>repeated .tutorial.Person peaople = 1;</code>
     */
    public com.example.tutorial.AddressBookProtos.PersonOrBuilder getPeaopleOrBuilder(
        int index) {
      return peaople_.get(index);
    }
    ...
    public final boolean isInitialized() {
      ...
      for (int i = 0; i < getPeaopleCount(); i++) {
        if (!getPeaople(i).isInitialized()) {
          memoizedIsInitialized = 0;
          return false;
        }
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      for (int i = 0; i < peaople_.size(); i++) {
        output.writeMessage(1, peaople_.get(i));
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < peaople_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, peaople_.get(i));
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getPeaopleList()
          .equals(other.getPeaopleList())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      int hash = 41;
      hash = (19 * hash) + getDescriptor().hashCode();
      if (getPeaopleCount() > 0) {
        hash = (37 * hash) + PEAOPLE_FIELD_NUMBER;
        hash = (53 * hash) + getPeaopleList().hashCode();
      }
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessageV3
                .alwaysUseFieldBuilders) {
          getPeaopleFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        super.clear();
        if (peaopleBuilder_ == null) {
          peaople_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
        } else {
          peaopleBuilder_.clear();
        }
        return this;
      }
      ...
      public com.example.tutorial.AddressBookProtos.AddressBook buildPartial() {
        ...
        if (peaopleBuilder_ == null) {
          ...
          result.peaople_ = peaople_;
        } else {
          result.peaople_ = peaopleBuilder_.build();
        }
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.example.tutorial.AddressBookProtos.AddressBook other) {
        ...
        if (peaopleBuilder_ == null) {
          if (!other.peaople_.isEmpty()) {
            if (peaople_.isEmpty()) {
              peaople_ = other.peaople_;
              bitField0_ = (bitField0_ & ~0x00000001);
            } else {
              ensurePeaopleIsMutable();
              peaople_.addAll(other.peaople_);
            }
            onChanged();
          }
        } else {
          if (!other.peaople_.isEmpty()) {
            if (peaopleBuilder_.isEmpty()) {
              peaopleBuilder_.dispose();
              peaopleBuilder_ = null;
              peaople_ = other.peaople_;
              bitField0_ = (bitField0_ & ~0x00000001);
              peaopleBuilder_ = 
                com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                   getPeaopleFieldBuilder() : null;
            } else {
              peaopleBuilder_.addAllMessages(other.peaople_);
            }
          }
        }
        this.mergeUnknownFields(other.unknownFields);
      ...
      private java.util.List<com.example.tutorial.AddressBookProtos.Person> peaople_ =
        java.util.Collections.emptyList();
      private void ensurePeaopleIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          peaople_ = new java.util.ArrayList<com.example.tutorial.AddressBookProtos.Person>(peaople_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          com.example.tutorial.AddressBookProtos.Person, com.example.tutorial.AddressBookProtos.Person.Builder, com.example.tutorial.AddressBookProtos.PersonOrBuilder> peaopleBuilder_;
      ...
      public java.util.List<com.example.tutorial.AddressBookProtos.Person> getPeaopleList() {
        if (peaopleBuilder_ == null) {
          return java.util.Collections.unmodifiableList(peaople_);
        } else {
          return peaopleBuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
      ...
      public int getPeaopleCount() {
        if (peaopleBuilder_ == null) {
          ...
          return peaopleBuilder_.getCount();
        }
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
      ...
      public com.example.tutorial.AddressBookProtos.Person getPeaople(int index) {
        if (peaopleBuilder_ == null) {
          ...
          return peaopleBuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
       */
      public Builder setPeaople(
        ...
        if (peaopleBuilder_ == null) {
          ...
          ensurePeaopleIsMutable();
          peaople_.set(index, value);
          onChanged();
        } else {
          peaopleBuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder setPeaople(
        ...
        if (peaopleBuilder_ == null) {
          ensurePeaopleIsMutable();
          peaople_.set(index, builderForValue.build());
          onChanged();
        } else {
          peaopleBuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
       */
      public Builder addPeaople(com.example.tutorial.AddressBookProtos.Person value) {
        if (peaopleBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ...
          peaopleBuilder_.addMessage(value);
        }
        return this;
      }
      /**
      ...
      public Builder addPeaople(
        ...
        if (peaopleBuilder_ == null) {
          ...
          ensurePeaopleIsMutable();
          peaople_.add(index, value);
          onChanged();
        } else {
          peaopleBuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
      ...
      public Builder addPeaople(
        ...
        if (peaopleBuilder_ == null) {
          ensurePeaopleIsMutable();
          peaople_.add(builderForValue.build());
          onChanged();
        } else {
          peaopleBuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addPeaople(
        ...
        if (peaopleBuilder_ == null) {
          ensurePeaopleIsMutable();
          peaople_.add(index, builderForValue.build());
          onChanged();
        } else {
          peaopleBuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addAllPeaople(
        ...
        if (peaopleBuilder_ == null) {
          ...
          peaopleBuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       ...
       * <code>repeated .tutorial.Person peaople = 1;</code>
       */
      public Builder removePeaople(int index) {
        if (peaopleBuilder_ == null) {
          ensurePeaopleIsMutable();
          peaople_.remove(index);
          onChanged();
        } else {
          peaopleBuilder_.remove(index);
        }
        return this;
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
       */
      public com.example.tutorial.AddressBookProtos.Person.Builder getPeaopleBuilder(
          int index) {
        return getPeaopleFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
       */
      public com.example.tutorial.AddressBookProtos.PersonOrBuilder getPeaopleOrBuilder(
          int index) {
        if (peaopleBuilder_ == null) {
          return peaople_.get(index);  } else {
          return peaopleBuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .tutorial.Person peaople = 1;</code>
      ...
      public java.util.List<? extends com.example.tutorial.AddressBookProtos.PersonOrBuilder> 
           getPeaopleOrBuilderList() {
        if (peaopleBuilder_ != null) {
          return peaopleBuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(peaople_);
        }
      }
       ...
       * <code>repeated .tutorial.Person peaople = 1;</code>
       */
      public com.example.tutorial.AddressBookProtos.Person.Builder addPeaopleBuilder() {
        return getPeaopleFieldBuilder().addBuilder(
      ...
      public java.util.List<com.example.tutorial.AddressBookProtos.Person.Builder> 
           getPeaopleBuilderList() {
        return getPeaopleFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          ...
          getPeaopleFieldBuilder() {
        if (peaopleBuilder_ == null) {
          peaopleBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              com.example.tutorial.AddressBookProtos.Person, com.example.tutorial.AddressBookProtos.Person.Builder, com.example.tutorial.AddressBookProtos.PersonOrBuilder>(
                  peaople_,
